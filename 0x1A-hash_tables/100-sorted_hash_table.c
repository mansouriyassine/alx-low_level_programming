...
/**
 * set_spair_only - Sets a key:value pair to the
 * first array element (no collision).
...
/**
 * set_spair_front - Sets a key:value pair node
 * to the front of the given index's list.
 * @ht: Pointer to the sorted hash table.
 * @key: The key (a non-empty string).
 * @value: The value associated with the key (can be an empty string).
 * @index: The key's index.
